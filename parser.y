...
%token <token> TPLUS TMINUS TMUL TDIV TINCRE TDECRE
...
%type <stmt> stmt var_decl func_decl extern_decl if_stmt while_stmt f_stmt for_stmt
...
stmt : var_decl TSEMIC | func_decl TSEMIC | extern_decl TSEMIC
